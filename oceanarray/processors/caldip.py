...
#: ASCII only: a non-ASCII byte (an em-dash here) is silently dropped from the global
#: attribute when the file is written on Windows, so provenance strings stay 7-bit.
CALDIP_STUB_APPLIED = (
